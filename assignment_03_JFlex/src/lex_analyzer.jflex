...
// setting input.txt for LA run->edit configuration->program argunemts->give file name || woring directory->give file location only upto the folder that contains the file
